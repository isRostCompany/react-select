  ...
  return _temp = _class = function(_Component) {
    ...
    function Creatable(props) {
      ...
      _this.onChange = function(newValue, actionMeta) {
        ...
        var newOption = _this.state.newOption, valueArray = Array.isArray(newValue) ? newValue : [ newValue ], possibleNewOption = valueArray[valueArray.length - 1];
        if (newOption && possibleNewOption.value === newOption.value && possibleNewOption.label === newOption.label) if (onCreateOption) onCreateOption(inputValue); else {
